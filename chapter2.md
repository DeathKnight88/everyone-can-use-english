...
说得形象点，说不出像哑巴，听不懂像聋子，读不懂像瞎子；而写不出呢？——大多数文化并不默认一个人写不了字是一种残疾。先不管能否写得出，只谈哑巴、聋子和瞎子。如果你必须成为这三种 “残疾” 中的一种，你会选哪个？我认真想过，我会选 “聋子” —— 因为不瞎不哑，起码还保留了输入和输出的渠道。我最怕成为 “瞎子” —— 因为那是最重要的输入手段，尤其是因为文字输入几乎占所有有效输入的绝大部分。某种意义上来说，学习一门外语最大的功用莫过于增加一个不一样的信息获得渠道。从这一点上来看，哑巴比聋子、瞎子强多了，而后两者之中，瞎子又远不如聋子。
